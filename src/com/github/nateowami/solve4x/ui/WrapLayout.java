...
/**
 * This class was written by Rob Camick and posted at
 * https://tips4java.wordpress.com/2008/11/06/wrap-layout/. The license is
 * specified at https://tips4java.wordpress.com/about/ and states the following:
 * <blockquote>You are free to use and/or modify any or all code posted on the
 * Java Tips Weblog without restriction. A credit in the code comments would be
 * nice, but not in any way mandatory.</blockquote>
 * 
 * This file has not been modified much; mainly just changes to conform to
 * standard sytle guides.
 * 
 * @author Rob Camick FlowLayout subclass that fully supports wrapping of
 *         components.
 */
